...
Тази инициатива със предложение-проектозакон до Народното събрание цели да подобри правната уредба на референдумите в България, за да отблокира този институт на национално и местно ниво. Към момента проектозаконът предвижда да се:
