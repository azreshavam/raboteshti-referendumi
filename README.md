...
Проектозаконът, мотивите към него и оценката на въздействието му са в папката [**ЗИД-ЗПУГДВМС**](https://github.com/azreshavam/raboteshti-referendumi/tree/main/%D0%97%D0%98%D0%94-%D0%97%D0%9F%D0%A3%D0%93%D0%94%D0%92%D0%9C%D0%A1). Документите са в [Markdown формат](https://www.markdownguide.org/basic-syntax/). 
Ако ако желаете да редактирате файловете директно, можете да разклоните хранилището (fork the repository), да редактирате файловете, които желаете и да изпратите Pull Request.
Можете и просто да добавите "Issue" с вашето предложение, забележка или въпрос.
