...
Тази инициатива със предложение-проектозакон до Народното събрание цели да подобри правната уредба на референдумите в България. Към момента проектозаконът предвижда това да стане като се:
